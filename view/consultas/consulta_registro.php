  ...
  <body class="bg-color-rgi">
    ...
    <div class="container-consultas">
      <div class="pop-box">
        <?php
            ...
            if(isset($_GET['protocolo_ok'])){
              ...
              echo "<h3 style=color:black;>Protocolo Não Encontrado, Verifique o Número Digitado</h3>";
            }else{
                echo '';
            }
      ...
      <div class="img-consultas">
            <h1 class="titulo-banner-consulta-firma">Consulte Seu Registro:</h1>
            <form class="form-consultas" action="consultar-registro.php" method="post">
                <input class="input-consultas" placeholder="Digite Seu Protocolo - Apenas Números" type="text" name="Protocolo">
                <br>
